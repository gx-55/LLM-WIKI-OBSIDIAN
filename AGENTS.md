...
`.codex/` is versioned agent configuration and skills for this vault. Treat it
as durable repository content, not scratch space. Its files should be tracked
directly in this repository so a future laptop clone has the same setup.
